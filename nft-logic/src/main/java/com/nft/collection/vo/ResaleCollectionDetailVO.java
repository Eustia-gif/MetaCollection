...
@Data
public class ResaleCollectionDetailVO {
	...
	public static ResaleCollectionDetailVO convertFor(MemberResaleCollection po) {
		if (po == null) {
			return null;
		}
		ResaleCollectionDetailVO vo = new ResaleCollectionDetailVO();
		vo.setModelPath(po.getModelPath());
		vo.setId(po.getId());
