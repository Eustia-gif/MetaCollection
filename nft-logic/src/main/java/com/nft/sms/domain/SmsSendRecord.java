...
public class SmsSendRecord implements Serializable {
	...
	public void fail(String errorMsg) {
		this.setState(Constant.SMS_SEND_STATUS_SEND_FAILED);
		this.setErrorMsg(errorMsg);
		this.setSendTime(new Date());
	}

	public void success() {
		this.setState(Constant.SMS_SEND_STATUS_SENT_SUCCESSFULLY);
		this.setSendTime(new Date());
	}
	...
	public static SmsSendRecord build(String mobile, String smsType, String verificationCode) {
		...
		po.setState(Constant.SMS_SEND_STATUS_NOT_SENT);
		return po;
	}
}
